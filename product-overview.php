<?php global $up_options;?>
				...
				<div class="imagecol" id="imagecol_<?php echo wpsc_the_product_id(); ?>">
					...
					?>
						<a rel="<?php echo wpsc_the_product_title(); ?>-<?php echo wpsc_the_product_id(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>" href="<?php echo wpsc_the_product_image(); ?>">
				...
				<div class="productcol">
					...
					<?php if($up_options->showdescription):?>
					...
					<?php /** the variation group HTML and loop ends here */?>
						...
						<?php if(wpsc_has_multi_adding()): ?>
                        	<fieldset><label><?php _e('Quantity', 'wpsc'); ?></label>
