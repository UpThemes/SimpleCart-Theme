...
$options = array (
	...
	array(	"name" => __('Info on Author Page','simplecart'),
			"desc" => __("Display a <a href=\"http://microformats.org/wiki/hcard\" target=\"_blank\">microformatted vCard</a> with the author's avatar, bio and email on the author page.",'simplecart'),
			"id" => "authorinfo",
			"value" => "false",
			"type" => "select",
			"default_text" => "No",
	...
	array(  "name" => "Footer HTML/Text",
            "desc" => "Enter your custom footer text or HTML here.",
            "id" => "footer_text",
            "type" => "textarea",
            "attr" => array('rows'=>10),
            "value" => '<a href="http://upthemes.com/themes/simplecart/">SimpleCart WordPress theme</a> by <a href="http://upthemes.com">UpThemes</a>'
    )
);
