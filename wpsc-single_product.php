		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					<div class="imagecol">
						<?php if ( wpsc_the_product_thumbnail() ) :
                                                        $wpsc_thumb = wpsc_the_product_thumbnail(get_option('single_view_image_width'),get_option('single_view_image_height'),'','single');?>
								<img class="product_image preview-pane" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo $wpsc_thumb; ?>" height="<?php echo get_option('single_view_image_height');?>" width="<?php echo get_option('single_view_image_width');?>" />
                                                                <div class="clear"></div>
                                                                <?php
                                                                /* Create thumbnail gallery */
                                                                $images = get_children(array('post_parent' => get_the_ID(), 'post_type' => 'attachment', 'order' => 'ASC', 'post_mime_type' => 'image',));
                                                                foreach($images as $image):
                                                                    $thumb = wp_get_attachment_image_src( $image->ID, 'tiny' );
                                                                    $large = wp_get_attachment_image_src( $image->ID, 'single-thumb' );?>
                                                                        <a rel="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?> product-thumb" href="<?php echo $large[0];?>">
                                                                            <img class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" height="64" width="64" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo $thumb[0]; ?>"/>
                                                                        </a>
                                                                <?php endforeach;?>
                                                                <div class="clear"></div>
								<?php 
						...
						<?php else: ?>
									...
									<img class="no-image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="No Image" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo WPSC_CORE_THEME_URL; ?>wpsc-images/noimage.png" width="<?php echo get_option('single_view_image_width'); ?>" height="<?php echo get_option('single_view_image_height'); ?>" />
									</a>
						<?php endif; ?>
					</div><!--close imagecol-->
